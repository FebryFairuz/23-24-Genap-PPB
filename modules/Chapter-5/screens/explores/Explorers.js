      ...
      <View style={styles.container}>
        ...
        <View style={styles.genreContainer}>
          <View style={styles.genreRow}>
            <TouchableOpacity
              onPress={() => navigation.navigate("DetailGenre")}
            >
              <View style={styles.genreCard}>
                <FontAwesome5 name={this.genreIcon1} size={20} color="orange" />
                <Text style={styles.genreCardText}>{this.genreName1}</Text>
              </View>
            </TouchableOpacity>
            <TouchableOpacity>
              <View style={styles.genreCard}>
                <FontAwesome5 name={this.genreIcon2} size={20} color="orange" />
          ...
          <View style={styles.genreRow}>
            <TouchableOpacity>
              <View style={styles.genreCard}>
                <FontAwesome5 name={this.genreIcon3} size={20} color="orange" />
                <Text style={styles.genreCardText}>{this.genreName3}</Text>
              </View>
            </TouchableOpacity>
            <TouchableOpacity>
              <View style={styles.genreCard}>
                <FontAwesome5 name={this.genreIcon4} size={20} color="orange" />
